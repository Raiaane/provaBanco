 ...
 * @author Raiane
 */
public class ExcluirLidos extends javax.swing.JFrame {

    /**
     * Creates new form ExcluirLidos
     */
    public ExcluirLidos() {
        initComponents();
        AtualizaCombo();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Livros lidos");
    ...
    private void nomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nomeActionPerformed
       Connection con = Conexao.AbrirConexao();
        ...
        lista = sql.ConsultaCodigoLidos(nom);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExcluirLidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
